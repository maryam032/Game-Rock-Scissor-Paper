   ...
   Winner=(e)=>
    ...
    render()      
    {
        return(<div style={{border:'1px solid #D6EAF8',width:'100%',height:600,backgroundColor:'#D6EAF8'}}>
            <center><button className="btn" style={{fontSize:20,color:'white',fontWeight:'bold',width:'130px',height:50,border:'none',outline:'none',marginTop:50,borderRadius:50}}name='Winner' value='Winner' onClick={this.Winner}>Winner</button>
               {this.state.showResult}
            <div style={{marginLeft:260,padding:15,border:'1px solid black',width:'300px',height:'300px',float:'left',alignItems:'center',backgroundColor:'#141A46'}}>
            ...
            <div style={{marginRight:300,padding:15,border:'1px solid black' ,width:'300px',height:'300px',float:'right',alignItems:'center',backgroundColor:'#141A46'}}>
